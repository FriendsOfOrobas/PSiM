...
const Zespol = ({game}) => {
  ...
  useEffect(()=>{
    const fetchData = async() =>{
      ...
      const team_res = await fetch("https://p-si-m-back.vercel.app/teams/"+game["id"]+"/"+user_res_data["id"], {
        headers:{
          "Authorization": authHeader()
        }
      })
      ...
      const team_det_res = await fetch("https://p-si-m-back.vercel.app/teams/team/"+team_res_data["id"], {
        headers:{
          "Authorization": authHeader()
        }
      })
      ...
      const teams_det_res = await fetch("https://p-si-m-back.vercel.app/teams/"+team_det_res_data["game_id"], {
        headers:{
          "Authorization": authHeader()
        }
      })
